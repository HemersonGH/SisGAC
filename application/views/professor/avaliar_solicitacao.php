...
<main class="row col-sm-9 offset-sm-3 col-md-10 offset-md-2 pt-3 main">
  ...
  <div class="form-control col-md-6">
    <form class="padding" action="<?= base_url(); ?>professor/salvar_avaliacao_solicitacao" method="post">
      ...
      <div class="row">
        <div class="col-md-12">
          <label for="disciplina_solicitada" class="padding paddingUp"> <h6> Disciplina Solicitada: </h6> </label>
      ...
      <a type="btn" class="paddingButton btn btn-secondary left" href="<?= base_url(); ?>professor/solicitacoes_disciplinas"> Cancelar </a>
